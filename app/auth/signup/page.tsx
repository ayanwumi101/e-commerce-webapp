...
// import { Mail, Lock, Eye, EyeOff, Loader2, ArrowRight, User, Phone, MapPin, Building, Globe } from "lucide-react"
...
//                     <Button type="button" className="w-full gap-2" onClick={handleNextStep}>
//                       Continue
...
//                       <Select onValueChange={(value) => setValue("region", value)} defaultValue={watch("region")}>
//                         <SelectTrigger>
...
export default function SignUpPage() {
  ...
  const {
    ...
    resolver: zodResolver(signupSchema) as any, // Type assertion to handle zod resolver type inference
    defaultValues: {
      name: "",
      email: "",
      phone: "",
